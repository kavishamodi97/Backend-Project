...
public class CouponDao {
    ...
    public CouponEntity getCouponUuid(final String couponUuid) {
        return entityManager.createNamedQuery("getCouponUuid", CouponEntity.class).setParameter("couponUuid", couponUuid).getSingleResult();
    }
}
