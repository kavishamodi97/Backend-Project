...
public class ItemDao {
    ...
    public ItemEntity getItemUuid(final String itemUuid) {
        return entityManager.createNamedQuery("getItemUuid", ItemEntity.class).setParameter("itemUuid", itemUuid).getSingleResult();
    }
}
